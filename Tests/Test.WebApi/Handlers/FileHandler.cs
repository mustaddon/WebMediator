...
{
    public class FileHandler : IRequestHandler<FileRequest, FileResponse>
    {
        public async Task<FileResponse> Handle(FileRequest request, CancellationToken cancellationToken)
        {
